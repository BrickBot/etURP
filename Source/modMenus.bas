...
With DrawInfo
    ...
    If ((IsSep = False) And (IsDisabled = False)) Or (IsDisabled = True And bSelectDisabled = True) Then
        ...
        Else
            XDrawGradient lSelectBColor, GetSysColor(COLOR_MENU), True, .hDC, mItem
            bGradientFill = True
        End If
    End If
    If IsSep Then
...
Public Function XDrawGradient(ByVal Color1 As Long, ByVal Color2 As Long, HorizontalGrade As Boolean, destDC As Long, dRect As RECT) As Long
' DO NOT CALL THIS ROUTINE FROM YOUR APPLICATION.
' =====================================================================
...
' Used by the XDrawGradient routine
' =====================================================================
Dim I As Long
